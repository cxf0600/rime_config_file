...
--引入系统变更处理模块
local sysInfoEnable, sysInfo = pcall(require, 'dyy/sysInfo')

--引入 utf8String 处理字符串相关操作
local utf8StringEnable, utf8String = pcall(require, 'dyy/utf8String')
...
function M.init(...)
	...
	table.insert(files,"phraseExt/common.txt")
	table.insert(files,"phraseExt/appEmoji.txt")
	table.insert(files,"phraseExt/emoji.txt")
	table.insert(files,"phraseExt/private.txt")
